...
const OUTPUT_DIR = path.join(__dirname, '..', 'assets', 'xiaohongshu', '06-evaluate');
const HTML_FILE = path.join(__dirname, 'xiaohongshu-canvas-06.html');
...
async function screenshot() {
    ...
    const cards = [
        ...
        { id: 'p2', name: '02-pain.png', desc: '痛点投票' },
        { id: 'p3', name: '03-compare.png', desc: '案例对比' },
        { id: 'p4', name: '04-criteria.png', desc: '评估标准' },
        { id: 'p5', name: '05-checklist.png', desc: '打回清单' },
